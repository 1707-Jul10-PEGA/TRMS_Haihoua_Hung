...
(
    ...
    CONSTRAINT FK_REQUEST_EMPLOYEE FOREIGN KEY (REQUEST_ID) REFERENCES EMPLOYEE (REQUEST_ID)
);
...
INSERT INTO EMPLOYEE VALUES (1,'Haihoua','Yang',null,'yangh1','pass','employee');
