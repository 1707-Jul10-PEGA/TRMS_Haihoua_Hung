...
function calculateReimbursement(){
	   ...
	   switch(type){
	   case "University Course": percent = .80;
	   	break;
	   case "Seminars": percent = .60;
	   	break;
	   case "Certificate Preparation Classes": percent = .75;
	   	break;
	   case "Certification": percent = 1;
	   	break;
	   case "Technical Training": percent = .90;
	   	break;
	   case "Other": percent = .30;
	   	break;
	   }
